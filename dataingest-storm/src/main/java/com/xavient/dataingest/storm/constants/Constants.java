package com.xavient.dataingest.storm.constants;
...
*/
	public static final String[] metadataJsonAttributes = { "activity_time"  ,
			 "activity_user_id"  ,
			 "activity_country_id"  ,
			 "activity_state_province"  ,
			 "activity_browser_id"  ,
			 "activity_os_id"  ,
			 "activity_type"  ,
			 "activity_sub_type"  ,
	...
	public static final String[] metadataXMLAttributes = { "activity_time"  ,
			 "activity_user_id"  ,
			 "activity_country_id"  ,
			 "activity_state_province"  ,
			 "activity_browser_id"  ,
